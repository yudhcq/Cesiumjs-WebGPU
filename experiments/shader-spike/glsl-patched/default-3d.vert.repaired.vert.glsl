...
layout(location = 7) out float v_distance;



layout(location = 8) out vec3 v_atmosphereRayleighColor;
layout(location = 9) out vec3 v_atmosphereMieColor;
layout(location = 10) out float v_atmosphereOpacity;
