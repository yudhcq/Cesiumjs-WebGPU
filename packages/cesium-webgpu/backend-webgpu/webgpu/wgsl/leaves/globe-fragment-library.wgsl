...
//
// GLSL source of truth: node_modules/@cesium/engine/Source/Shaders/GlobeFS.js + AtmosphereCommon.js
// Ported from the verified leaf (webgpu/wgsl/leaves/terrain-fs-lib.wgsl);
