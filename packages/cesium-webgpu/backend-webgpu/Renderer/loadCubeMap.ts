 ...
 *
 * Modified for WebGPU backend: module-level replacement of `Source/Renderer/loadCubeMap.js`
...
const UPSTREAM_MODULE = "Renderer/loadCubeMap.js";
const NOT_IMPLEMENTED = "cube map loading (depends on the slice-C CubeMap stub)";
