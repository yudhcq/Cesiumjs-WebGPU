 ...
 *
 * Modified for WebGPU backend: module-level replacement of `Source/Renderer/Sync.js`
...
const UPSTREAM_MODULE = "Renderer/Sync.js";
const NOT_IMPLEMENTED = "GL fence synchronisation (same family as the readPixels stub)";
