 ...
 *
 * Modified for WebGPU backend: module-level replacement of `Source/Renderer/CubeMap.js`
...
const UPSTREAM_MODULE = "Renderer/CubeMap.js";
const NOT_IMPLEMENTED = "cube maps (sky box / IBL / model environment)";
...
export default class CubeMap {
  ...
  constructor(..._args: unknown[]) {
    throwNotImplemented(NOT_IMPLEMENTED, {
      ...
      entryPoint: "CubeMap#constructor",
